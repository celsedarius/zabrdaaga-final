                ...
                <div class="card-body">
                    ...
                    <form class="forms-sample" method="post" id="cat_form">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="Name" id="Name" placeholder="entrer le nom de la categorie">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="exampleInputPassword2" class="col-sm-3 col-form-label">Type</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="Type" id="Type" placeholder="entrer le type de la categorie">
                            </div>
                        </div>
