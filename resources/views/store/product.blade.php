        ...
        <div class="row">
            ...
            <div class="col-md-5">
                <div class="product-details">
                    ...
                    <div>
                        <h3 class="product-price"> {{$product->discount}} F<del class="product-old-price"> {{$product->price}} F</del></h3>
...
<script>
    ...
    $(document).ready(function() {
		...
		$("#order_form").validate({
            ...
            document.getElementById("for_error").innerHTML = "<label class='error' style=' '>Invalide</label>";
