        ...
        <!-- row -->
            ...
            <div class="col-md-5 order-details" style="width: 100%;">
                ...
                <div id="order_summary" class="order-summary">
                    ...
                    <div class="rTable">
                        <div class="rTableRow">
                            <div class="rTableHead"><strong>SUPPRIMER</strong></div>
                            <div class="rTableHead"><strong>ARTICLE</strong></div>
...
<!--                            -->
                    ...
                    <div class="order-col">
                        ...
                        <div ><strong class="order-total" id="totalCost">{{Session::get('price')}} F</strong></div>
                    </div>
                    @else
                    <div class="order-col">
                ...
                <div class="payment-method">
                    <div class="input-radio">
                        ...
                        <div class="caption">
                            <p>L'article sera livrer dans les 24 heures suivant votre confirmation.</p>
                        </div>
                    </div>
                </div>
                @if(session('user'))
                   ...
                   <center> <form method="post" name="cart">
                    ...
                    @else
                        <a href="{{route('user.home')}}"><input type="button"  class="primary-btn order-submit" value="commander maintenant"></a>
                    @endif
    ...
    var url="{{route('user.signup.check_email')}}";
            ...
            $.ajax({
                ...
                success:function(msg){
                        ...
                        if(msg == "1")
                            {
                                document.getElementById("for_duplicate-email").innerHTML = "<label class='error'>Cet email est deja utiliser</label>";
