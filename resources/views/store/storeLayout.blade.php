            ...
            <div class="container">
                ...
                <ul class="header-links pull-right">
                    @if(session()->has('user'))
                      ...
                      <li><a href="{{route('user.logout')}}"><i class="fa fa-user-o"></i> Deconnexion</a></li>
                    @else
                    <li><a href="{{route('user.login')}}"><i class="fa fa-user-o"></i> Connexion</a></li>
                    
                    <li><a href="{{route('user.signup')}}"><i class="fa fa-user-o"></i> S'enregistrer</a></li>
                    @endif
                        ...
                        <div class="header-search">
                            <form action="{{route('user.search')}}" method="get">
                                <div class="custom_search_top" >
                                    <input class="input" style="border-radius: 40px 0px 0px 40px;" name="n" placeholder="á rechercher">
        ...
        <div class="container">
            ...
            <div id="responsive-nav">
                ...
                <ul class="main-nav nav navbar-nav">
                    <li class="{{Route::is('user.home') ? 'active' : ''}}"><a href="{{route('user.home')}}">Accueuil</a></li>
                    @if(Route::is('user.search'))
                        @foreach($cat as $c)
                        <li class="{{$c->id == $a ? 'active' : ''}}"><a href="{{route('user.search.cat',['id'=>$c->id])}}" >{{$c->name}}</a></li>
                        @endforeach
                        <li class="{{$a == -1  ? 'active' : ''}}"><a href="search">Tout afficher</a></li>
                    @else
                        @foreach($cat as $c)
                        <li ><a href="{{route('user.search.cat',['id'=>$c->id])}}" >{{$c->name}}</a></li>
                        @endforeach
                        <li ><a href="{{route('user.search')}}">Tout afficher</a></li>
                    @endif
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-xs-6">
                    <div class="shop">
                        ...
                        <div class="shop-body">
                            <h3>{{$c->name}}</h3>
                            <a href="search?c={{$c->id}}" class="cta-btn">Acheter maintenant <i class="fa fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                </div>
                <!-- /shop -->
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="newsletter">
                        <p>Souscrivez à la <strong>NEWSLETTER</strong></p>
                        <form>
                            <input class="input" type="email" placeholder="Enter Your Email">
                            <button class="newsletter-btn"><i class="fa fa-envelope"></i> Souscription</button>
                        </form>
                    ...
                    <div class="col-md-3 col-xs-6" >
                        <div class="footer" >
                            ...
                            <ul class="footer-links">
                                ...
                                <li><a href="#"><i class="fa fa-phone"></i>65 10 42 64</a></li>
